...
/**
 * This class will test UserGUI objects
 * The data needed to input to the test methods 
 * will be printed to the console for easy access and review
 *
 * @author (Jesse Nelson) 
...
public class UserGUITest {
    ...
    public void getChoicesTest() {
        UserGUI UI = new UserGUI();
        System.out.println("\nEnter lasagna for your first choice");
    ...
    /**
     * This test test's the void method getCharacteristicRanking()
     */
    @Test
